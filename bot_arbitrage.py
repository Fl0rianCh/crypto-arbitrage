...
def find_arbitrage_opportunity():
    try:
        ...
        if None in [usdc_usdt_price, btc_usdc_price, eth_usdc_price, sol_usdc_price, 
                    arb_usdc_price, wif_usdc_price, bnb_usdc_price, xrp_usdc_price, 
        ...
        net_profits['wif'] = ((investment / Decimal(wif_usdc_price)) * Decimal(btc_usdc_price)) * (1 - total_fees) - investment
